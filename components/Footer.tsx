    ...
    <footer style={{ background: '#000000', borderTop: '1px solid rgba(255,255,255,0.08)', padding: 'clamp(48px, 8vw, 80px) 0 36px' }}>
      <div className="container-padded" style={{ maxWidth: 1440, margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 'clamp(28px, 5vw, 48px)', marginBottom: 'clamp(40px, 6vw, 64px)' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
            <a href="#" style={{ display: 'flex', alignItems: 'center', gap: 12, textDecoration: 'none' }}>
              <div style={{ width: 32, height: 32, background: 'linear-gradient(135deg, #e8e8e8 0%, #a0a0a0 50%, #c8c8c8 100%)', borderRadius: 8, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
              ...
              <div>
                ...
                <div style={{ fontSize: 7, fontWeight: 700, color: '#9ca3af', letterSpacing: '0.3em', textTransform: 'uppercase' }}>MARKETS</div>
              </div>
            </a>
            <p style={{ fontSize: 13, color: '#6b7280', lineHeight: 1.65, maxWidth: 240 }}>
        ...
        <div style={{ borderTop: '1px solid rgba(255,255,255,0.08)', paddingTop: 28 }}>
          <p style={{ fontSize: 11, color: '#6b7280', lineHeight: 1.8, marginBottom: 20 }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 16 }}>
            ...
            <div style={{ display: 'flex', gap: 20 }}>
              {['Twitter', 'LinkedIn', 'Telegram'].map(s => (
                <a key={s} href="#" style={{ fontSize: 12, color: '#9ca3af', textDecoration: 'none', transition: 'color 0.2s' }}
  ...
  return (
    <div>
      ...
      <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: 12 }}>
        {links.map(l => (
          <li key={l}>
            <a href="#" style={{ fontSize: 13, color: '#9ca3af', textDecoration: 'none', transition: 'color 0.2s', fontWeight: 500 }}
              onMouseOver={e => (e.currentTarget.style.color = '#fff')}
              onMouseOut={e  => (e.currentTarget.style.color = '#9ca3af')}
            >{l}</a>
          </li>
